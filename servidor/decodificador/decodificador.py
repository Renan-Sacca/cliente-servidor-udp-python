import json
from servidor.db.banco_redis import banco_redis
from servidor.decodificador.quebrar_dados import quebrar_dados
from servidor.data.data import datas
...
def decodificar(msg):
    ...
    for i in msg[1:]:
        ...
        dados_quebrados = quebrar_dados(dados_quebrados)
